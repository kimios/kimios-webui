...
export class FiletransferService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public downloadFile(sessionId?: string, transactionId?: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public downloadFile(sessionId?: string, transactionId?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public downloadFile(sessionId?: string, transactionId?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public downloadFile(sessionId?: string, transactionId?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/filetransfer/downloadFile`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public startDownloadTransaction(sessionId?: string, documentVersionId?: number, isCompressed?: boolean, convertToPdf?: boolean, observe?: 'body', reportProgress?: boolean): Observable<DataTransaction>;
    public startDownloadTransaction(sessionId?: string, documentVersionId?: number, isCompressed?: boolean, convertToPdf?: boolean, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<DataTransaction>>;
    public startDownloadTransaction(sessionId?: string, documentVersionId?: number, isCompressed?: boolean, convertToPdf?: boolean, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<DataTransaction>>;
    public startDownloadTransaction(sessionId?: string, documentVersionId?: number, isCompressed?: boolean, convertToPdf?: boolean, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (convertToPdf !== undefined && convertToPdf !== null) {
            queryParameters = queryParameters.set('convertToPdf', <any>convertToPdf);
        }
