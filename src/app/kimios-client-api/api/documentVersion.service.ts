...
export class DocumentVersionService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getMediaType(sessionId?: string, documentVersionId?: number, observe?: 'body', reportProgress?: boolean): Observable<StringResponse>;
    public getMediaType(sessionId?: string, documentVersionId?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<StringResponse>>;
    public getMediaType(sessionId?: string, documentVersionId?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<StringResponse>>;
    public getMediaType(sessionId?: string, documentVersionId?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<StringResponse>(`${this.basePath}/document-version/getMediaType`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
