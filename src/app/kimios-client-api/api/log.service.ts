...
import { UpdateNoticeMessage } from '../model/updateNoticeMessage';
...
export class LogService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public sendUpdateNotice(body?: UpdateNoticeMessage, observe?: 'body', reportProgress?: boolean): Observable<UpdateNoticeMessage>;
    public sendUpdateNotice(body?: UpdateNoticeMessage, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<UpdateNoticeMessage>>;
    public sendUpdateNotice(body?: UpdateNoticeMessage, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<UpdateNoticeMessage>>;
    public sendUpdateNotice(body?: UpdateNoticeMessage, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<UpdateNoticeMessage>(`${this.basePath}/log/sendUpdateNotice`,
            body,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
