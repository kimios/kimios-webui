...
export class RuleService {
     ...
     */
    public createRule(observe?: 'body', reportProgress?: boolean): Observable<any>;
    public createRule(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public createRule(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public createRule(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getAvailablesRules(observe?: 'body', reportProgress?: boolean): Observable<Array<string>>;
    public getAvailablesRules(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<string>>>;
    public getAvailablesRules(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<string>>>;
    public getAvailablesRules(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getRuleParam(observe?: 'body', reportProgress?: boolean): Observable<string>;
    public getRuleParam(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<string>>;
    public getRuleParam(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<string>>;
    public getRuleParam(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
