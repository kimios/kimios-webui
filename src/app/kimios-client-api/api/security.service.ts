 ...
 * Kimios Sample API
 *
 * OpenAPI spec version: 1.3-SNAPSHOT - a41f1270d4baf89c2ed0fbc92f8e795c93d9e52f
...
export class SecurityService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public startSession(userName: string, userSource: string, password: string, observe?: 'body', reportProgress?: boolean): Observable<{ [key: string]: any; }>;
    public startSession(userName: string, userSource: string, password: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<{ [key: string]: any; }>>;
    public startSession(userName: string, userSource: string, password: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<{ [key: string]: any; }>>;
    public startSession(userName: string, userSource: string, password: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<{ [key: string]: any; }>(`${this.basePath}/security/startSession`,
            convertFormParamsToString ? formParams.toString() : formParams,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
