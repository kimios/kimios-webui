 ...
 * Kimios Sample API
 *
 * OpenAPI spec version: 1.3-SNAPSHOT - 1e4034f51dedcbeff4c0890f545a28ec4e1279bd
...
import { ShareByEmailFullContactParam } from '../model/shareByEmailFullContactParam';
...
export class ShareService {
    ...
    public downloadDocumentByToken(token?: string, password?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/share/downloadDocumentByToken`,
            {
    ...
    public downloadDocumentByTokenAndPassword(token?: string, password?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.basePath}/share/downloadDocumentByTokenAndPassword`,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listDocumentShares(sessionId?: string, documentId?: number, observe?: 'body', reportProgress?: boolean): Observable<Array<Share>>;
    public listDocumentShares(sessionId?: string, documentId?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Share>>>;
    public listDocumentShares(sessionId?: string, documentId?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Share>>>;
    public listDocumentShares(sessionId?: string, documentId?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Share>>(`${this.basePath}/share/document`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public listEntitiesSharedByMe(sessionId?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Share>>(`${this.basePath}/share/by-me`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public listEntitiesSharedWithMe(sessionId?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Share>>(`${this.basePath}/share/with-me`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public loadDefaultTemplate(sessionId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<string>(`${this.basePath}/share/load-default-template`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public removeShare(sessionId?: string, shareId?: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public removeShare(sessionId?: string, shareId?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public removeShare(sessionId?: string, shareId?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public removeShare(sessionId?: string, shareId?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (shareId !== undefined) {
            formParams = formParams.append('shareId', <any>shareId) || formParams;
        }

        return this.httpClient.post<any>(`${this.basePath}/share/remove`,
            convertFormParamsToString ? formParams.toString() : formParams,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public retrieveShare(sessionId?: string, id?: number, observe?: 'body', reportProgress?: boolean): Observable<Share>;
    public retrieveShare(sessionId?: string, id?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Share>>;
    public retrieveShare(sessionId?: string, id?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Share>>;
    public retrieveShare(sessionId?: string, id?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Share>(`${this.basePath}/share`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public searchContact(sessionId: string, query: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<MailContact>>(`${this.basePath}/share/search-contact`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public shareByEmailFullContact(sessionId?: string, documentIds?: Array<number>, recipients?: Array<MailContact>, subject?: string, content?: string, senderAddress?: string, senderName?: string, defaultSender?: boolean, password?: string, expirationDate?: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public shareByEmailFullContact(sessionId?: string, documentIds?: Array<number>, recipients?: Array<MailContact>, subject?: string, content?: string, senderAddress?: string, senderName?: string, defaultSender?: boolean, password?: string, expirationDate?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public shareByEmailFullContact(sessionId?: string, documentIds?: Array<number>, recipients?: Array<MailContact>, subject?: string, content?: string, senderAddress?: string, senderName?: string, defaultSender?: boolean, password?: string, expirationDate?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public shareByEmailFullContact(sessionId?: string, documentIds?: Array<number>, recipients?: Array<MailContact>, subject?: string, content?: string, senderAddress?: string, senderName?: string, defaultSender?: boolean, password?: string, expirationDate?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (recipients) {
            recipients.forEach((element) => {
                queryParameters = queryParameters.append('recipients', <any>element);
            });
        }
        ...
        return this.httpClient.post<any>(`${this.basePath}/share/share-by-mail`,
            null,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public shareByEmailFullContact_1(body?: ShareByEmailFullContactParam, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public shareByEmailFullContact_1(body?: ShareByEmailFullContactParam, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public shareByEmailFullContact_1(body?: ShareByEmailFullContactParam, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public shareByEmailFullContact_1(body?: ShareByEmailFullContactParam, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.basePath}/share/share-by-mail-obj-param`,
            body,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public shareDocument(sessionId?: string, dmEntityId?: number, targetUserId?: string, targetUserSource?: string, read?: boolean, write?: boolean, fullAccess?: boolean, expirationDate?: string, notify?: boolean, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.basePath}/share/share-document`,
            convertFormParamsToString ? formParams.toString() : formParams,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateShare(sessionId?: string, id?: number, targetUserId?: string, targetUserSource?: string, read?: boolean, write?: boolean, fullAccess?: boolean, expirationDate?: string, notify?: boolean, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public updateShare(sessionId?: string, id?: number, targetUserId?: string, targetUserSource?: string, read?: boolean, write?: boolean, fullAccess?: boolean, expirationDate?: string, notify?: boolean, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public updateShare(sessionId?: string, id?: number, targetUserId?: string, targetUserSource?: string, read?: boolean, write?: boolean, fullAccess?: boolean, expirationDate?: string, notify?: boolean, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public updateShare(sessionId?: string, id?: number, targetUserId?: string, targetUserSource?: string, read?: boolean, write?: boolean, fullAccess?: boolean, expirationDate?: string, notify?: boolean, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.basePath}/share/update`,
            convertFormParamsToString ? formParams.toString() : formParams,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
