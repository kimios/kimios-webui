...
export const APIS = [AdministrationService, DocumentService, DocumentVersionService, FiletransferService, FolderService, InformationService, LogService, NotificationService, ReportingService, RuleService, SearchService, SecurityService, ShareService, StudioService, WorkspaceService];
