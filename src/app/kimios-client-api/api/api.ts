...
export const APIS = [AdministrationService, ConverterService, DefaultService, DocumentService, DocumentVersionService, DocumentVersionRestOnlyService, EditorsService, FiletransferService, FolderService, InformationService, LogService, NotificationService, ReportingService, RuleService, SearchService, SecurityService, ShareService, StudioService, WorkspaceService];
