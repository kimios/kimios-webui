 ...
 * Kimios Sample API
 *
 * OpenAPI spec version: 1.3-SNAPSHOT - bccb82021055ae6c0066b7c8e66a3c636aca94c7
...
export class StudioService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getDocumentType(sessionId?: string, documentTypeId?: number, observe?: 'body', reportProgress?: boolean): Observable<DocumentType>;
    public getDocumentType(sessionId?: string, documentTypeId?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<DocumentType>>;
    public getDocumentType(sessionId?: string, documentTypeId?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<DocumentType>>;
    public getDocumentType(sessionId?: string, documentTypeId?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
