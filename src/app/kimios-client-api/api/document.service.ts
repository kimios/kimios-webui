...
export class DocumentService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createDocumentFromFullPathWithPropertiesNoHash(document: InputStream, sessionId?: string, path?: string, isSecurityInherited?: boolean, securityItems?: string, isRecursive?: boolean, documentTypeId?: number, metaItems?: string, md5?: string, sha1?: string, observe?: 'body', reportProgress?: boolean): Observable<number>;
    public createDocumentFromFullPathWithPropertiesNoHash(document: InputStream, sessionId?: string, path?: string, isSecurityInherited?: boolean, securityItems?: string, isRecursive?: boolean, documentTypeId?: number, metaItems?: string, md5?: string, sha1?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<number>>;
    public createDocumentFromFullPathWithPropertiesNoHash(document: InputStream, sessionId?: string, path?: string, isSecurityInherited?: boolean, securityItems?: string, isRecursive?: boolean, documentTypeId?: number, metaItems?: string, md5?: string, sha1?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<number>>;
    public createDocumentFromFullPathWithPropertiesNoHash(document: InputStream, sessionId?: string, path?: string, isSecurityInherited?: boolean, securityItems?: string, isRecursive?: boolean, documentTypeId?: number, metaItems?: string, md5?: string, sha1?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
