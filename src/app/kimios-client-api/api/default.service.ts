...
export class DefaultService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public trashEntity(sessionId?: string, dmEntityId?: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public trashEntity(sessionId?: string, dmEntityId?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public trashEntity(sessionId?: string, dmEntityId?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public trashEntity(sessionId?: string, dmEntityId?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public trashEntityForce(sessionId?: string, dmEntityId?: number, force?: boolean, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public trashEntityForce(sessionId?: string, dmEntityId?: number, force?: boolean, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public trashEntityForce(sessionId?: string, dmEntityId?: number, force?: boolean, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public trashEntityForce(sessionId?: string, dmEntityId?: number, force?: boolean, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/extension/trashForce`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
