 ...
 * Kimios Sample API
 *
 * OpenAPI spec version: 1.3-SNAPSHOT - f89758f43b14d4796fca8cc6dd9ae240b3fa7534
...
export namespace UpdateNoticeMessage {
    export type UpdateNoticeTypeEnum = 'SHARES_BY_ME' | 'SHARES_WITH_ME' | 'DOCUMENT' | 'FOLDER' | 'WORKSPACE' | 'PREVIEW_READY' | 'PREVIEW_PROCESSING' | 'KEEP_ALIVE_PING' | 'KEEP_ALIVE_PONG' | 'USER_GROUP_ADD' | 'USER_GROUP_REMOVE';
