 ...
 * Kimios Sample API
 *
 * OpenAPI spec version: 1.3-SNAPSHOT - 20cb8884a894063c009a2723048cdd2c8fe48726
...
export namespace UpdateNoticeMessage {
    export type UpdateNoticeTypeEnum = 'SHARES_BY_ME' | 'SHARES_WITH_ME' | 'DOCUMENT' | 'FOLDER' | 'WORKSPACE' | 'PREVIEW_READY' | 'PREVIEW_PROCESSING' | 'KEEP_ALIVE_PING' | 'KEEP_ALIVE_PONG' | 'USER_GROUP_ADD' | 'USER_GROUP_REMOVE' | 'USER_CREATED' | 'USER_MODIFIED' | 'USER_REMOVED' | 'GROUP_CREATED' | 'GROUP_REMOVED' | 'GROUP_MODIFIED' | 'WORKSPACE_CREATED' | 'WORKSPACE_UPDATED' | 'WORKSPACE_REMOVED' | 'FOLDER_CREATED' | 'FOLDER_UPDATED' | 'FOLDER_REMOVED' | 'DOCUMENT_CREATED' | 'DOCUMENT_UPDATE' | 'DOCUMENT_VERSION_CREATED' | 'DOCUMENT_VERSION_UPDATED' | 'DOCUMENT_REMOVED' | 'DOCUMENT_CHECKOUT' | 'DOCUMENT_CHECKIN' | 'DOCUMENT_ADD_RELATED' | 'DOCUMENT_REMOVE_RELATED' | 'DOCUMENT_VERSION_CREATE' | 'DOCUMENT_VERSION_CREATE_FROM_LATEST' | 'DOCUMENT_VERSION_UPDATE' | 'DOCUMENT_VERSION_READ' | 'META_VALUE_UPDATE' | 'DOCUMENT_VERSION_COMMENT_CREATE' | 'DOCUMENT_VERSION_COMMENT_UPDATE' | 'DOCUMENT_VERSION_COMMENT_DELETE' | 'DOCUMENT_TRASH' | 'DOCUMENT_UNTRASH' | 'DOCUMENT_SHARED';
